...
def communication_wizard(object):
        ...
        comm_1_label_7_0 = Label(comm_tab_1, text="Port: 1 ").grid(row=7, column=0, sticky="wn", padx=5)
        comm_1_label_8_0 = Label(comm_tab_1, text="Port: 2 ").grid(row=8, column=0, sticky="wn", padx=5)
        ...
        def get_entry(TAB_NUM):
                global comm_1_output_3_1 # TCP
                global comm_1_output_4_1 # TCP
                global comm_1_output_5_1 # TCP
                global comm_1_output_6_1 # TCP
                global comm_1_output_7_1 # TCP
                global comm_1_output_8_1 # TCP

                global comm_2_output_3_1 # Serial/CAN
                global comm_2_output_4_1 # Serial/CAN
                global comm_2_output_5_1 # Serial/CAN
                global comm_2_output_6_1 # Serial/CAN
                global comm_2_output_7_1 # Serial/CAN
                global comm_2_output_8_1 # Serial/CAN

                global comm_3_output_3_1 # Bluetooth
                global comm_3_output_4_1 # Bluetooth
                global comm_3_output_5_1 # Bluetooth
                global comm_3_output_6_1 # Bluetooth
                global comm_3_output_7_1 # Bluetooth
                global comm_3_output_8_1 # Bluetooth

                global comm_4_output_3_1 # Wifi
                global comm_4_output_4_1 # Wifi
                global comm_4_output_5_1 # Wifi
                global comm_4_output_6_1 # wifi
                global comm_4_output_7_1 # wifi
                global comm_4_output_8_1 # wifi

                #tab 1 get TCP settings
                comm_1_output_3_1 = comm_1_entry_3_1.get()
                comm_1_output_4_1 = comm_1_entry_4_1.get()
                comm_1_output_5_1 = comm_1_entry_5_1.get()
                comm_1_output_6_1 = comm_1_entry_6_1.get()
                comm_1_output_7_1 = comm_1_entry_7_1.get()
                comm_1_output_8_1 = comm_1_entry_8_1.get()
                
                #tab 2 get Serial/CAN Settings
                comm_2_output_3_1 = comm_2_entry_3_1.get()
                comm_2_output_4_1 = comm_2_entry_4_1.get()
                comm_2_output_5_1 = comm_2_entry_5_1.get()
                comm_2_output_6_1 = comm_2_entry_6_1.get()
                comm_2_output_7_1 = comm_2_entry_7_1.get()
                comm_2_output_8_1 = comm_2_entry_8_1.get()

                #tab 3 get Bluetooth settings
                comm_3_output_3_1 = comm_3_entry_3_1.get()
                comm_3_output_4_1 = comm_3_entry_4_1.get()
                comm_3_output_5_1 = comm_3_entry_5_1.get()
                comm_3_output_6_1 = comm_3_entry_6_1.get()
                comm_3_output_7_1 = comm_3_entry_7_1.get()
                comm_3_output_8_1 = comm_3_entry_8_1.get()

                #tab 4 get Wifi settings
                comm_4_output_3_1 = comm_4_entry_3_1.get()
                comm_4_output_4_1 = comm_4_entry_4_1.get()
                comm_4_output_5_1 = comm_4_entry_5_1.get()
                comm_4_output_6_1 = comm_4_entry_6_1.get()
                comm_4_output_7_1 = comm_4_entry_7_1.get()
                comm_4_output_8_1 = comm_4_entry_8_1.get()

                print("Tab_NUMBER: ", TAB_NUM)
                print("COM1_1: ", comm_1_output_3_1)
                print("COM1_2: ", comm_1_output_4_1)
                print("COM1_3: ", comm_1_output_5_1)
                print("COM1_4: ", comm_1_output_6_1)
                print("COM1_5: ", comm_1_output_7_1)
                print("COM1_6: ", comm_1_output_8_1)

                print("Tab_NUMBER: ", TAB_NUM)
                print("COM2_1: ", comm_2_output_3_1)
                print("COM2_2: ", comm_2_output_4_1)
                print("COM2_3: ", comm_2_output_5_1)
                print("COM2_4: ", comm_2_output_6_1)
                print("COM2_5: ", comm_2_output_7_1)
                print("COM2_6: ", comm_2_output_8_1)

                print("Tab_NUMBER: ", TAB_NUM)
                print("COM3_1: ", comm_3_output_3_1)
                print("COM3_2: ", comm_3_output_4_1)
                print("COM3_3: ", comm_3_output_5_1)
                print("COM3_4: ", comm_3_output_6_1)
                print("COM3_5: ", comm_3_output_7_1)
                print("COM3_6: ", comm_3_output_8_1)

                print("Tab_NUMBER: ", TAB_NUM)
                print("COM4_1: ", comm_4_output_3_1)
                print("COM4_2: ", comm_4_output_4_1)
                print("COM4_3: ", comm_4_output_5_1)
                print("COM4_4: ", comm_4_output_6_1)
                print("COM4_5: ", comm_4_output_7_1)
                print("COM4_6: ", comm_4_output_8_1)
                
                TCP_IP = comm_1_output_3_1
                comm_1_output_7_1 = int(comm_1_output_7_1)
